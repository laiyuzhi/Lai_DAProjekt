...
def load_data(dataname):
    ...
    if dataname == 'Speed300' or dataname == 'Speed500' or dataname == 'Luft':
        print(dataname)
        ...
        if dataname == 'Luft':
            model.load_state_dict(torch.load('/mnt/projects_sdc/lai/Lai_DAProjekt/Modell/ModelLuft1081.mdl'))
        else:
            model.load_state_dict(torch.load('/mnt/projects_sdc/lai/Lai_DAProjekt/Modell/modelspeed21681.mdl'))
...
# draw distribution for FN daten
